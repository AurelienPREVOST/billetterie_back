...
module.exports = (mailTo, subject, title, text) => {
    ...
    const oauth2Client = new OAuth2(
        "5948566XXXXXXXXXXXXXXXXXXXln80nvfs9aa8cppu.apps.googleusercontent.com", //client_id
        "GOCSPX-PXXXXXXXXXXXX", //client_secret
    ...
    let transporter = nodeMailer.createTransport({
        ...
        auth: {
            ...
            clientId: "59485XXXXXXXXXXXXXXXXXXfs9aa8cppu.apps.googleusercontent.com",
            clientSecret: "GOCSPXXXXXXXXXXXXXXXXXXXSotMF_",
            //REMPLACER PAR LE TOKEN TEMPORAIRE https://developers.google.com/oauthplayground
